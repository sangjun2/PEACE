...
public class SearchDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < SplashActivity.placeList.size(); i++) {
            if(SplashActivity.placeList.get(i).getName().contains(searchData)) {
                searchPlaces.add(SplashActivity.placeList.get(i));
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(new SearchDetailListAdapter(searchPlaces));
